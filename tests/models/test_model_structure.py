...
def test_all_37_tables_in_metadata():
    ...
    expected_tables = {
        ...
        # 域19: 考点讲解(kp_lecture,取代旧 node_resource 六维)+ 教材主数据
        "kp_lecture", "curriculum_catalog",
    ...
    assert len(actual_tables) == 133, f"期望 133 张表，实际 {len(actual_tables)} 张: {sorted(actual_tables)}"
