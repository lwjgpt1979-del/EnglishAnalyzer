    ...
    for nid in node_ids:
        ...
        if source_question_id is not None:
            stmt = stmt.on_conflict_do_nothing(
                index_elements=["student_id", "node_id", "source_question_id"],
        ...
        r = await db.execute(stmt.returning(StudentKpTarget.id))
