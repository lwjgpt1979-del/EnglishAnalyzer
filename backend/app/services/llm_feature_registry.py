...
LLM_FEATURES: list[dict] = [
    ...
    {"feature": "vocab_word_kp", "mode": "chat", "surface": "小程序端", "module": "词力通·考点深挖", "service": "word_kp_service",
     "purpose": "挖单词考点:固定搭配/近义/反义/派生/易混/考法(义关折叠卡,关系型落库)", "why": "词典式考点抽取、规格明确、fast 档", "locations": ["word_kp_service.py:35"], "cache": "global", "store": "vocab_word_kp(词根)+vocab_word_relation(六维关系,按 word_id,查看即生成+预热)"},
    ...
    {"feature": "vocab_kp_mcq", "mode": "chat", "surface": "小程序端", "module": "词力通·考点扩展测试", "service": "word_kp_service",
     "purpose": "按考点维度出题:每个有内容的维度(搭配/近义/反义/派生/易混/考法)各 3 道单选,测试每维随机取 1", "why": "结构化按维出题、规格明确、fast 档", "locations": ["word_kp_service.py:_gen_kp_mcqs"], "cache": "global", "store": "vocab_kp_mcq(FK vocab_word_kp,按 word_id 一次生成、每维随机取,查看即生成+预热)"},
