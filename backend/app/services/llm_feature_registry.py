...
LLM_FEATURES: list[dict] = [
    ...
    {"feature": "vocab_kp_mcq_fix", "mode": "chat", "surface": "运营后台", "module": "词力通·考点题AI审校修正", "service": "word_kp_service",
     "purpose": "被学生「换一题」报错达阈值的考点题,AI 审校修正答案/解析/干扰项(保证答案唯一无歧义);自动或后台手动触发", "why": "结构化审校修正、规格明确、fast 档", "locations": ["word_kp_service.py:_gen_fix_mcq"], "cache": "none", "store": "更新 vocab_kp_mcq + 记 vocab_kp_mcq_revision(before/after);report_count 归 0"},
