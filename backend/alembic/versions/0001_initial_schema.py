...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("role", postgresql.ENUM("student","teacher","relative","institution_admin","branch_admin","platform_admin", name="user_role", create_type=False), nullable=False),
        sa.Column("is_active", sa.Boolean(), server_default=sa.text("true"), nullable=False),
        sa.Column("city_code", sa.String(), nullable=True),
        sa.Column("city_source", postgresql.ENUM("ip_auto","manual", name="city_source", create_type=False), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("pending","active","suspended", name="institution_status", create_type=False), server_default=sa.text("'pending'"), nullable=False),
        sa.Column("created_at", sa.TIMESTAMP(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.TIMESTAMP(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(), nullable=False),
        sa.Column("category", postgresql.ENUM("grammar","vocabulary","reading","writing","listening", name="knowledge_category", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("semester", postgresql.ENUM("上","下", name="semester", create_type=False), nullable=True),
        sa.Column("updated_at", sa.TIMESTAMP(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("id", sa.UUID(as_uuid=True), sa.ForeignKey("users.id"), primary_key=True),
        sa.Column("institution_id", sa.UUID(as_uuid=True), sa.ForeignKey("institutions.id"), nullable=True),
        sa.Column("cert_status", postgresql.ENUM("uncertified","pending","certified","rejected", name="cert_status", create_type=False), server_default=sa.text("'uncertified'"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("type", postgresql.ENUM("relative_bind","institution_join", name="invite_code_type", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("student_id", sa.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=False),
        sa.Column("bind_type", postgresql.ENUM("institution_assigned","self_bound", name="bind_type", create_type=False), nullable=False),
        sa.Column("bind_source", postgresql.ENUM("sms_invite","miniprogram_link","institution_assigned", name="bind_source", create_type=False), nullable=False),
        sa.Column("status", postgresql.ENUM("pending","active","rejected","inactive", name="teacher_student_status", create_type=False), nullable=False),
        sa.Column("institution_id", sa.UUID(as_uuid=True), sa.ForeignKey("institutions.id"), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("order_type", postgresql.ENUM("new","renew","upgrade", name="order_type", create_type=False), nullable=False),
        sa.Column("tier", postgresql.ENUM("basic","pro","promax", name="order_tier", create_type=False), nullable=False),
        sa.Column("duration_months", sa.Integer(), nullable=False),
        sa.Column("amount_fen", sa.Integer(), nullable=False),
        sa.Column("status", postgresql.ENUM("pending","paid","refunded","partial_refunded", name="order_status", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("tier", postgresql.ENUM("free","basic","pro","promax", name="membership_tier", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("amount_fen", sa.Integer(), nullable=False),
        sa.Column("refund_type", postgresql.ENUM("standard_7d","prorated","appeal", name="refund_type", create_type=False), nullable=False),
        sa.Column("status", postgresql.ENUM("pending","approved","rejected","completed", name="refund_status", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("question_type", postgresql.ENUM("单选","完型","阅读","作文","其他", name="question_type", create_type=False), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("pending","processing","completed","failed", name="ocr_status", create_type=False), nullable=False),
        sa.Column("provider", postgresql.ENUM("aliyun_print","baidu_print","tencent_handwrite","google_handwrite", name="ocr_provider", create_type=False), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("wrong_question_id", sa.UUID(as_uuid=True), sa.ForeignKey("wrong_questions.id"), nullable=False),
        sa.Column("student_id", sa.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=False),
        sa.Column("llm_provider", postgresql.ENUM("deepseek","claude", name="llm_provider", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("semester", postgresql.ENUM("上","下", name="semester", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("level", postgresql.ENUM("new","learning","review","mastered", name="vocab_level", create_type=False), nullable=False),
        sa.Column("created_at", sa.TIMESTAMP(timezone=True), server_default=sa.func.now(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("draft","processing","completed", name="essay_status", create_type=False), nullable=False),
        sa.Column("created_at", sa.TIMESTAMP(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.TIMESTAMP(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("processing","completed","failed", name="listening_status", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("question_type", postgresql.ENUM("单选","填空","完型","阅读","写作", name="ai_question_type", create_type=False), nullable=False),
        sa.Column("difficulty", sa.SmallInteger(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("trigger_type", postgresql.ENUM("module8_free","wrong_q_followup", name="trigger_type", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("draft","published","closed", name="assignment_status", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.UUID(as_uuid=True), primary_key=True),
        sa.Column("student_id", sa.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=False),
        sa.Column("report_type", postgresql.ENUM("weekly","monthly", name="report_type", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.UUID(as_uuid=True), primary_key=True),
        sa.Column("user_id", sa.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=False),
        sa.Column("type", postgresql.ENUM("system","membership","assignment","analysis_done","report_ready","bind_request","bind_accepted","bind_rejected","ocr_failed", name="notification_type", create_type=False), nullable=False),
        sa.Column("title", sa.String(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("draft","confirmed","paid", name="settlement_status", create_type=False), nullable=False),
